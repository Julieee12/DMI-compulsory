...
import "../Styles/retro.css"; // This CSS file will contain some retro-specific styles.
...
const AdminPage: React.FC = () => {
    ...
    return (
        <div className="admin-container" style={{ display: "flex", margin: "8px" }}>
            ...
            <div className="admin-main-content" style={{ flex: 1, padding: "20px", border: "2px solid black", backgroundColor: "#f3f3f3", fontFamily: "Courier New, monospace" }}>
                ...
                <form style={{ marginBottom: "20px", border: "1px solid #333", padding: "10px", backgroundColor: "#fff" }} onSubmit={handleCustomerSubmit}>
                    ...
                    <button type="submit" style={{ backgroundColor: "lime", padding: "10px", border: "2px solid black" }}>Create Customer</button>
                </form>

                <h2 style={{ backgroundColor: "yellow", padding: "5px" }}>Add a New Product</h2>
                <form style={{ border: "1px solid #333", padding: "10px", backgroundColor: "#fff" }} onSubmit={handleProductSubmit}>
                    <div style={{ marginBottom: "10px" }}>
                    ...
                    <button type="submit" style={{ backgroundColor: "lime", padding: "10px", border: "2px solid black" }}>Add Product</button>
                </form>
